...
class PE:
    ...
    def __init__(self, FileBuff):
        ...
        self.SizeOfOptionalHeader = hex(self.getvalue(offset=self.FileHeader + 0x10))
        ...
        self.SizeOfHeaders = hex(self.getvalue(offset=self.OP_Header + 0x3c))  # PE头大小
    ...
    def info(self):
        ...
        print('*****************PE头*********************')
        print('==> PE文件头大小: {}'.format(self.SizeOfHeaders))
        print('PE标志位: {}'.format(self.PE_Signature))
        print('时间戳: {}'.format(self.TimeDateStamp))
        print('\n')

        print('*****************可选PE头*********************')
        print('==> 可选PE头大小: {}'.format(self.SizeOfOptionalHeader))
        ...
        while IMAGE_IMPORT_DESCRIPTOR(self.FileBuff,
            ...
            while IMAGE_THUNK_DATA32(self.FileBuff, THUNK_OFFSET).Ordinal != 0:
                ...
                print('\t{}\t\t\t\t{}'.format(thunk_name.Name, thunk_func.function))
                FUNC_OFFSET += 0x4
                THUNK_OFFSET += 0x4
            print('\n')
